  ...
  <div class="box pad" id="submitRoot">
    ...
    <form id="submitForm" style="margin-top:10px;display:grid;gap:8px;">
      <div style="display:grid;grid-template-columns:1.15fr .85fr .85fr;gap:8px;">
        <select id="sb_operator" class="input"><option value="mts">🔴 МТС</option><option value="bil">🟡 Билайн</option><option value="vtb">🔵 ВТБ</option><option value="gaz">🔵 Газпром</option><option value="mega">🟢 Мегафон</option><option value="t2">⚫ Tele2</option></select>
